...
public:
	...
	int		nHeartSpan;		//心跳发送处理间隔
	int		nUpdateSpan;	//更新检测处理间隔
	int		nDownLoadSpan;	//数据下载间隔
	int		m_nCommport;	//设备串口号

	DWORD	dwHeartCheck;	//心跳检测时间点
	DWORD	dwUpdateCheck;	//更新检测时间点
	DWORD	dwDwonLoadCheck;//下载检测时间点
