 ...
 * 
 * 文件名称：SMNewlandFM420.h
 * 摘    要：新大陆NSL-FM420扫码器通讯协议解析控制类，声明文件
 * 当前版本：1.0.0.1
 * 作    者：ROCY
 * 创建日期：2015年11月1日
 */
...
class CSMNewlandFM420 :	public CScanMachineIF
{
public:
	CSMNewlandFM420(IN const int& iSMType);
	~CSMNewlandFM420(void);
