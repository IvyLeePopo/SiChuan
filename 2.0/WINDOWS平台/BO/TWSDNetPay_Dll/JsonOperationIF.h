...
public:
	...
	virtual CString	FormatSendData2Json(IN const CDVJsonDebit* pDVJsonDebit)=0;
	//将接收到的数据结构转化为标准的JSON格式 -- 支付请求(查询)
	virtual CString	FormatSendData2Json(IN const CDVJsonDebitCheck* pDVJsonDebitCheck)=0;
