...
const bool CDVXMLDebitParamContext::Init( const QString& strXMLString)
{

    qDebug()<<"into CDVXMLDebitParamContext::Init:";
    bool bReturn = false;
    ...
    try
    {
       ...
       /**************************************************************************/
        ...
        QDomElement t_DEData = m_ReRoot.firstChildElement("Data");
        ...
        if(!FindThreeChildElem("PayCertificateType"))
            throw -35;
        PayCertificateType = GetThreeChildElem().toInt();


        if(!FindThreeChildElem("PayCertificateCode"))
            throw -34;
        PayCertificateCode = GetThreeChildElem();
        ...
        if(!FindThreeChildElem("StationID"))
            throw -22;
        EntryStationID = GetThreeChildElem().toInt();
        ...
        if(!FindThreeChildElem("Time"))
            throw -24;
       // strTemp =    m_ReElement.attributeNode("Time").value();
//???
