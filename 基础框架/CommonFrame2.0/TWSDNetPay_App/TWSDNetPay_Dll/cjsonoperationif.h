...
//接口定义
    ...
    virtual QString	FormatSendData2Json( const CDVJsonDebitCheck* pDVJsonDebitCheck)=0;
    ...
    virtual QString	FormatSendData2Json( const CDVJsonDebitSecond* pDVJsonDebitSecond)=0;

    //将接收到的数据结构转化为标准的JSON格式 -- 心跳
    virtual QString	FormatSendData2Json( const CDVJsonHeart* pDVJsonHeart)=0;
