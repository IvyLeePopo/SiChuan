...
//            ((CDVJsonParamDebitMoney*)pDVJsonBase)->PayCertificateCode = Debit["PayCertificateCode"].asCString();
            ...
            ((CDVJsonParamDebitMoney*)pDVJsonBase)->SubTime = Debit["SubTime"].asCString();
                    //CTime(GetGlobalApp()->CString2time_t(Debit["SubTime"].asCString()));
...
//tiaoshi
    ...
    case JSON_DT_PARAM_DEBIT_CANCLE:
    {
        try
        {
            ...
            if(Json::intValue == TradeKeyItem["Type"].type())
                ((CDVJsonParamDebitCancel*)pDVJsonBase)->m_type = TradeKeyItem["Type"].asInt();
            else
                ((CDVJsonParamDebitCancel*)pDVJsonBase)->m_type = 1;
        ...
        catch(int& iErrorCode)
        {
            ...
            qDebug()<<"JSON_DT_PARAM_DEBIT_CANCLE异常: "<<iErrorCode;
        }
    ...
    case JSON_DT_PARAM_DEBIT_RESULT:
    {
        try
        {
            ...
            qDebug()<<"pDVJsonBase)->PayIdentifier:"<<((CDVJsonParamDebitResult*)pDVJsonBase)->PayIdentifier;
...
//tiaoshi
            ((CDVJsonParamDebitResult*)pDVJsonBase)->DebitTime = TradeKeyItem["DebitTime"].asCString();
                    //::GetGlobalApp()->CString2time_t(TradeKeyItem["DebitTime"].asCString());
        ...
        catch(int& iErrorCode)
        {
            ...
            qDebug()<<"JSON_DT_PARAM_DEBIT_RESULT 异常: "<<iErrorCode;
        }
