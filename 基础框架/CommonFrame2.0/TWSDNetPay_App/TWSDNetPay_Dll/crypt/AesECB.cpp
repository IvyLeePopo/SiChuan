...
CAesECB::CAesECB(const QString& strKey)
    :m_strKey(strKey)
{
}
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
const QString CAesECB::EncryptData(const QString& strSrc)
{
    std::string strData = Encrypt((LPCSTR)strSrc.toStdString().c_str(),(LPCSTR)m_strKey.toStdString().c_str());
    QString strReturn;
    strReturn.sprintf("%s", strData.c_str());
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
const QString CAesECB::DecryptData(const QString& strSrc)
{
    std::string strData = Decrypt((LPCSTR)strSrc.toStdString().c_str(),(LPCSTR)m_strKey.toStdString().c_str());
    QString strReturn;
    strReturn.sprintf("%s", strData.c_str());
    return strReturn;
}
...
std::string CAesECB::Encrypt( std::string strSrc, std::string strKey )
{
    ...
    if(NULL != pDest)
    {
        ...
        strRet = (LPCSTR)Bin2Hex(pDest,nDestLen).toStdString().c_str();
        delete [] pDest;
    }
    return strRet;
}
...
//////////////////////////////////////////////////////////////////////////////////////////
void CAesECB::Hex2Bin(LPTSTR lpHex, PBYTE pBin, DWORD dwHex_len)
{
    if(dwHex_len%2)
        return;
    ...
    for (int i = 0; i < strTemp.length()/2; i++) {
        BYTE a = (BYTE)(strTemp.at(i*2).toLatin1() >='A')?(BYTE)(strTemp.at(i*2).toLatin1()-'A'+10):(BYTE)(strTemp.at(i*2).toLatin1()-'0');
        BYTE b = (BYTE)(strTemp.at(i*2+1).toLatin1()>='A')?(BYTE)(strTemp.at(i*2+1).toLatin1()-'A'+10):(BYTE)(strTemp.at(i*2+1).toLatin1()-'0');
...
//////////////////////////////////////////////////////////////////////////////////////////
QString CAesECB::Bin2Hex(PBYTE pBin, DWORD dwBin_Len)
{
    QString strHex;
    QString strTemp;
